          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/30">
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Dernière activité</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Queue</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Blockages</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Créée</th>
              </tr>
            </thead>
            <tbody>
